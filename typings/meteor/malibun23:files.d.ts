declare module "meteor/malibun23:files" {
    import {Modifier, ObjectID, Selector} from "meteor/mongo";
    ...
    export class FilesCollection {
        ...
        update(selector: Selector<FileObj> | ObjectID | string, modifier: Modifier<FileObj>, options?: {
            multi?: boolean;
            upsert?: boolean;
            validate?:boolean;
